				...
				<div class="container">
					<div class="row d-flex justify-content-between">
						<div class="topbar-left">
							<ul>
								<li><a href="Learner-faq.jsp"><i
										class="fa fa-question-circle"></i>Ask a Question</a></li>
								<li><a href="javascript:;"><i class="fa fa-envelope-o"></i>Support@website.com</a></li>
							</ul>
						</div>
						<div class="topbar-right">
							<ul>
								<li><select class="header-lang-bx">
										<option data-icon="flag flag-uk">English UK</option>
										<option data-icon="flag flag-us">English US</option>
								</select></li>
								<li><a href="Learner-profile.jsp">Profile</a></li>
					...
					<div class="container clearfix">
						...
						<div
							...
							<ul class="nav navbar-nav">
								<li class="active"><a href="Learner-index.jsp">Home </a></li>
								<li class="active"><a href="Learner-about.jsp">About </a>
								</li>
								<li class="active"><a href="Learner-contact.jsp">Contact
								</a></li>
								<li><a href="javascript:;">Pages <i
										class="fa fa-chevron-down"></i></a>
									<ul class="sub-menu">
										<li><a href="Learner-faq.jsp">FAQ's</a></li>
										<li><a href="Learner-portfolio.jsp">Portfolio</a></li>
										<li><a href="Learner-profile.jsp">Profile</a></li>
									</ul></li>
								<li class="add-mega-menu"><a href="javascript:;">Our
									...
									<ul class="sub-menu add-menu">
										<li class="add-menu-left">
											...
											<ul>
												<li><a href="Learner-courses.jsp">Courses </a></li>
												<li><a href="Learner-courses-details.jsp">Courses
														Details</a></li>
											</ul>
										</li>
									</ul></li>
						...
						<div class="row">
							<div class="courses-carousel owl-carousel owl-btn-1 col-12 p-lr0">
								<div class="item">
									<div class="cours-bx">
										<div class="action-box">
											<img src="assets/images/courses/pic1.jpg" alt=""> <a
												href="Learner-courses-details.jsp" class="btn">Read
												More</a>
										</div>
										<div class="info-bx text-center">
											<h5>
												<a href="Learner-courses-details.jsp">Introduction
													EduChamp – LMS plugin</a>
											</h5>
								...
								<div class="item">
									<div class="cours-bx">
										<div class="action-box">
											<img src="assets/images/courses/pic2.jpg" alt=""> <a
												href="Learner-courses-details.jsp" class="btn">Read
												More</a>
										</div>
										<div class="info-bx text-center">
								...
								<div class="item">
									<div class="cours-bx">
										<div class="action-box">
											<img src="assets/images/courses/pic3.jpg" alt=""> <a
												href="Learner-courses-details.jsp" class="btn">Read
												More</a>
										</div>
										<div class="info-bx text-center">
								...
								<div class="item">
									<div class="cours-bx">
										<div class="action-box">
											<img src="assets/images/courses/pic4.jpg" alt=""> <a
												href="Learner-courses-details.jsp" class="btn">Read
												More</a>
										</div>
										<div class="info-bx text-center">
					...
					<div class="container">
						<div class="d-flex align-items-stretch">
							<div class="pt-logo mr-auto">
								<a href="Learner-index.jsp"><img
									src="assets/images/logo-white.png" alt="" /></a>
							</div>
							...
							<div class="row">
								<div class="col-4 col-lg-4 col-md-4 col-sm-4">
									<div class="widget footer_widget">
										...
										<ul>
											<li><a href="Learner-index.jsp">Home</a></li>
											<li><a href="Learner-about.jsp">About</a></li>
											<li><a href="Learner-faq.jsp">FAQs</a></li>
											<li><a href="Learner-contact.jsp">Contact</a></li>
										</ul>
									</div>
								</div>
								<div class="col-4 col-lg-4 col-md-4 col-sm-4">
									<div class="widget footer_widget">
										...
										<ul>
											<li><a>+91 9876543210</a></li>
											<li><a>edu@support.com</a></li>
											<li><a>Karpagam college of Engineering</a></li>
										</ul>
									</div>
								</div>
							</div>
