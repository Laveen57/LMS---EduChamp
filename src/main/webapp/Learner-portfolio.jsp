...
<div id="loading-icon-bx"></div>
			...
			<div class="container">
				<div class="row d-flex justify-content-between">
					<div class="topbar-left">
						<ul>
							<li><a href="Learner-faq.jsp"><i class="fa fa-question-circle"></i>Ask a Question</a></li>
		...
		<div class="sticky-header navbar-expand-lg">
            <div class="menu-bar clearfix">
                <div class="container clearfix">
					<!-- Header Logo ==== -->
					<div class="menu-logo">
						<a href="Learner-index.jsp"><img src="assets/images/logo.png" alt=""></a>
					</div>
					<!-- Mobile Nav Button ==== -->
                    ...
                    <div class="menu-links navbar-collapse collapse justify-content-start" id="menuDropdown">
                        ...
                        <ul class="nav navbar-nav">	
							<li class="active"><a href="Learner-index.jsp">Home </a>
							</li>
							<li class="active"><a href="Learner-about.jsp">About </a>
							</li>
							<li class="active"><a href="Learner-contact.jsp">Contact </a>
							</li>
								...
								<ul class="sub-menu add-menu">
									<li class="add-menu-left">
										...
										<ul>
											...
											<li><a href="Learner-courses-details.jsp">Courses Details</a></li>
										</ul>
									</li>
								</ul>
							</li>
    ...
    <footer>
				...
				<div class="container">
					<div class="d-flex align-items-stretch">
						<div class="pt-logo mr-auto">
							<a href="Learner-index.jsp"><img src="assets/images/logo-white.png" alt=""/></a>
						</div>
        ...
        <div class="footer-bottom">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 text-center"><p>Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved</p></div>
                </div>
            </div>
        </div>
    </footer>
