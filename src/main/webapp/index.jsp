                        ...
                        <ul class="nav navbar-nav">	
							...
							<li class="add-mega-menu"><a href="javascript:;">Our Courses <i class="fa fa-chevron-down"></i></a>
								<ul class="sub-menu add-menu">
									...
									<li class="add-menu-right"><a href="register.jsp">
										<img src="assets/images/adv/adv.jpg" alt=""/></a>
									</li>
								</ul>
							</li>
						</ul>
						...
						<div class="item">
							<div class="cours-bx">
								<div class="action-box">
									...
									<a href="courses-details.jsp" class="btn">Read More</a>
								</div>
								<div class="info-bx text-center">
									<h5><a href="courses-details.jsp">Introduction EduChamp – LMS plugin</a></h5>
			...
			<div class="section-area section-sp2 bg-fix ovbl-dark join-bx text-center" style="background-image:url(assets/images/background/bg1.jpg);">
                <div class="container">
					<div class="row">
						...
						<div class="col-md-12">
							<div class="join-content-bx">
								<a href="register.jsp" class="btn button-md">Join Now</a>
							</div>
						</div>
					</div>
					<div class="row">
