		...
		<div class="account-form">
			...
			<div class="account-form-inner">
				<div class="account-container">
					...
					<form class="contact-bx" action="RegisterServlet" method="post" onsubmit="callsuccess()">
						<div class="row placeani">
							...
							<div class="col-lg-12">
								...
								<div class="form-group">
								<div class="input-group">
								<input type="radio" id="Instructor" value="Instructor" name="Domain"> Instructor
								<input type="radio" id="Learner" value="Learner" name="Domain"> Learner
								</div>
									</div>
								</div>
							</div>
